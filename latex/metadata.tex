\hypersetup{
 ...
 pdftitle={A Search for Boosted Low Mass Resonances Decaying to the b bbar Final State and Produced in Association with a Jet at sqrt {s} = 13~TeV with the ATLAS Detector}, % Title in PDF document properties
