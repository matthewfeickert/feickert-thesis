...
% Specify where atlaslatex.git was cloned to
\newcommand*{\ATLASLATEXPATH}{latex/atlaslatex/latex/}
\usepackage[unit]{latex/atlaslatex/latex/atlasphysics}
...
\begin{thesis}
 ...
 \input{src/statistical_software.tex}
 ...
 \raggedright
 \bibliography{bib/Luminosity,bib/Higgs,bib/JDM}
