...
\FirstDegree%
\FirstDegreeType{B.S.}
\FirstDegreeMajor{Engineering Physics}
\FirstDegreeUniversity{University of Illinois at Urbana-Champaign}
...
\ThesisDefenseDateMonth{July}
\ThesisDefenseDateDay{XX}

\GraduationDateYear{2019}
\GraduationDateMonth{August}
\GraduationDateDay{YY}
