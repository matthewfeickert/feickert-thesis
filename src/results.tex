...
\begin{figure}[htbp]
 \centering
 \includegraphics[width=\linewidth]{results/untagged_analysis_g_q_limits.eps}
...
\begin{figure}[htbp]
 \centering
 \includegraphics[width=\linewidth]{results/CMS-PAS-EXO-18-012_Zprime_limits.pdf}
