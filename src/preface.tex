...
\begin{quote}
 For example, if I throw a ball at a glass window one square foot in area, there may be once chance in ten that the window will break, and nine chances in ten that the ball will just bounce.
