...
\newglossaryentry{IBL}{
 text=IBL,
 long=Insertable $B$-layer,
 name={\glsentrylong{IBL} (\glsentrytext{IBL})},
 first={\glsentryname{IBL}},
 sort=insertable $B$-layer,
 description={Additional fourth layer of pixel detectors in the ATLAS \glsentrylong{inner detector} that was installed in 2014.
   The $B$-layer is named as such to reflect that the additional pixel layer will improve tracking information helpful in flavor tagging},
}
...
\newglossaryentry{TGC}{
 ...
 description={Thin multiwire proportional chamber with thick field wires with an operating gas mixture filling the chamber gap},
}
...
\newglossaryentry{TRT}{
 ...
 description={Combined tracking and electron identification drift tube detector in the ATLAS \glsentrylong{inner detector}},
}
...
\newglossaryentry{TDAQ}{
 ...
 description={The combined system comprised of the Level-1 hardware and HLT software trigger systems along with the subdetector data readout and buffer systems},
}
