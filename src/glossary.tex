...
\newglossaryentry{BDT}{
 ...
 description={A machine learning algorithm that uses the weighted score of an ensemble of decision trees (flows of orthogonal selection criteria) to give a discriminant score.
