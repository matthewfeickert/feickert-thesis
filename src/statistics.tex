...
\[
 \lambda\left(t\right) = \frac{L\left(t\middle|\, \hat{\hat{\theta}}\,\right)}{L\left(\hat{t}\,\middle|\, \hat{\theta}\right)}\,,
\]
...
\begin{figure}[htbp]
 ...
 \caption[Simulation of 100 $95\%$ confidence level confidence intervals]{%
  ...
  Each measurement is the result of $45$ samples from a Normal distribution.
